...
gcloud run deploy ${SERVICE_NAME} \
    ...
    --set-secrets DATABASE_URL=battle-worker-secrets:latest,GOOGLE_GENERATIVE_AI_API_KEY=battle-worker-secrets:latest,SERPER_API_KEY=battle-worker-secrets:latest,CURRENTS_API_KEY=battle-worker-secrets:latest,WORKER_API_KEY=battle-worker-secrets:latest
