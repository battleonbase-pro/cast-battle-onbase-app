...
gcloud run deploy ${SERVICE_NAME} \
    ...
    --set-secrets DATABASE_URL=database-url:latest,GOOGLE_GENERATIVE_AI_API_KEY=google-generative-ai-api-key:latest,SERPER_API_KEY=serper-api-key:latest,WORKER_API_KEY=battle-worker-secrets:latest
