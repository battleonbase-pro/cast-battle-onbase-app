...
# ERC-4337 EntryPoint contract address (Base Sepolia)
...
```bash
# DebatePool contract address (deployed on Base Mainnet)
NEXT_PUBLIC_DEBATE_POOL_CONTRACT_ADDRESS_MAINNET=

# USDC contract address (Base Mainnet)
NEXT_PUBLIC_USDC_ADDRESS_MAINNET=0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913

# ERC-4337 EntryPoint contract address (Base Mainnet)
NEXT_PUBLIC_ENTRY_POINT_ADDRESS_MAINNET=0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789
```
