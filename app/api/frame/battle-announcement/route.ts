    ...
    const frameHtml = `
      ...
      <html>
        <head>
          ...
          <meta property="og:title" content="Cast Battle: ${battle.topic}" />
          <meta property="og:description" content="Join the daily cast battle and win BATTLE tokens! Source: ${battle.source}" />
        </head>
        <body>
          <h1>Cast Battle: ${battle.topic}</h1>
