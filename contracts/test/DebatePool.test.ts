...
import { DebatePool } from "../typechain-types/contracts/DebatePool";
...
describe("DebatePool", function () {
    ...
    beforeEach(async function () {
        ...
        // Deploy DebatePoolV2
        const DebatePoolFactory = await ethers.getContractFactory("DebatePool");
        debatePool = await DebatePoolFactory.deploy(
    ...
    describe("Joining Debates", function () {
        ...
        it("Should prevent joining expired debates", async function () {
            ...
            ).to.be.revertedWith("DebatePool: Debate has ended");
        });
        ...
        it("Should prevent joining full debates", async function () {
            ...
            ).to.be.revertedWith("DebatePool: Debate is full");
        });
        ...
        it("Should prevent joining same debate twice", async function () {
            ...
            await expect(
                debatePool.connect(user1).joinDebate(1)
            ).to.be.revertedWith("DebatePool: Already participating");
        });
    });
    ...
    describe("Winner Declaration", function () {
        ...
        it("Should prevent declaring winner for completed debate", async function () {
            ...
            ).to.be.revertedWith("DebatePool: Debate is not active");
        });
    });
    ...
    describe("Refund System", function () {
        ...
        it("Should prevent refunds before debate expires", async function () {
            ...
            ).to.be.revertedWith("DebatePool: Debate not expired");
        });
        ...
        it("Should prevent refunds after winner is declared", async function () {
            ...
            ).to.be.revertedWith("DebatePool: Winner already declared");
        });
    ...
    describe("Emergency Controls", function () {
        ...
        it("Should prevent operations when paused", async function () {
            ...
            ).to.be.revertedWith("DebatePool: Contract is paused");
        });
    });
